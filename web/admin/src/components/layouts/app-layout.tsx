  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {/* Footer — slim single-row strip matching the design mock */}
        <footer className="shrink-0 border-t bg-background">
          <div className="mx-auto flex w-full max-w-screen-2xl flex-col items-start justify-between gap-1 px-4 py-2.5 text-[11px] text-muted-foreground sm:flex-row sm:items-center sm:px-6 lg:px-8">
            ...
            {/* right cluster: live status · ⌘K search · ? shortcuts · GitHub */}
            <div className="flex flex-wrap items-center gap-x-3 gap-y-1">

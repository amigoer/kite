...
// The system supports multiple storage configurations; administrators can register local,
// S3-compatible, Aliyun OSS, Tencent COS, or FTP backends. The config field stores the
// driver-specific payload as JSON.
